...
public class RomanToInteger {
    ...
    private static int romanIntoDecimal = 0;
...
//            System.out.println("0 - changeByPredecessor = " + changeByPredecessor);
            ...
            if(RomanNumber.I.toString().equals(romanToParse)) {
                index = processRomanNumberI(romanNumberSplited, changeByPredecessor, index);
            } else if(RomanNumber.V.toString().equals(romanToParse)) {
                index = processRomanNumberV(romanNumberSplited, changeByPredecessor, index);
            } else if(RomanNumber.X.toString().equals(romanToParse)) {
                index = processRomanNumberM(romanNumberSplited, changeByPredecessor, index);
            } else if(RomanNumber.L.toString().equals(romanToParse)) {
                index = processRomanNumberL(romanNumberSplited, changeByPredecessor, index);
            } else if(RomanNumber.C.toString().equals(romanToParse)) {
                index = processRomanNumberC(romanNumberSplited, changeByPredecessor, index);
            } else  if(RomanNumber.D.toString().equals(romanToParse)) {
                index = processRomanNumberD(romanNumberSplited, changeByPredecessor, index);
    ...
    private static void processRomanNumberM() {
        romanIntoDecimal += RomanNumber.M.getDecimalNumber();
        System.out.println("M - romanIntoDecimal = " + romanIntoDecimal);
    }

    private static int processRomanNumberD(final ArrayList<String> romanNumberSplited, final boolean changeByPredecessor, int index) {
    ...
    private static int processRomanNumberC(final ArrayList<String> romanNumberSplited, final boolean changeByPredecessor, int index) {
    ...
    private static int processRomanNumberL(final ArrayList<String> romanNumberSplited, final boolean changeByPredecessor, int index) {
    ...
    private static int processRomanNumberM(final ArrayList<String> romanNumberSplited, final boolean changeByPredecessor, int index) {
    ...
    private static int processRomanNumberV(final ArrayList<String> romanNumberSplited, final boolean changeByPredecessor, int index) {
    ...
    private static int processRomanNumberI(final ArrayList<String> romanNumberSplited, final boolean changeByPredecessor, int index) {
